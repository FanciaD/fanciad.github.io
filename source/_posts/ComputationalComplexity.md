...
date: '2025-01-09 20:21:06'
updated: '2025-01-09 20:21:06'
tags: Fancia
permalink: Phosphene/
...
特征值分解完考虑随机游走，那么本来 $u=\sum c_iv_i$，之后就变成 $c_i\lambda_i^tv_i$。因为正交，$1/n(1,1,\cdots,1)$ 前面的系数必然是 $1$。那么除了极端情况（图有非平凡循环周期，无向的时候就是二分图），剩下的特征值模长都小于 $1$，然后就可以发现 $A^kv\to 1/n(1,1,\cdots,1)$，所以随机游走会收敛到均匀情况。
...
### XXII PCP and Boolean Function Analysis

### XXIII the Natural Proof Barrier